...
const PRE_PAINT = `try{var e=localStorage.getItem('theme');var d=matchMedia('(prefers-color-scheme: dark)').matches;if(e==='dark'||((e===null||e==='system')&&d))document.documentElement.classList.add('dark');if(!localStorage.getItem('talgasy-welcome-v3'))document.documentElement.classList.add('welcome')}catch(e){}`;

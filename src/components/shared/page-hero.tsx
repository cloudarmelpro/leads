      ...
      <div className={`${CONTENEUR} relative flex flex-col items-start gap-6`}>
        ...
        {cta && (
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href={cta.href}
              className="rounded-[8px] bg-vert px-3.5 py-2 sm:px-4 sm:py-2.5 text-cta-fluid font-normal text-sur-vert no-underline transition-colors hover:bg-vert-clair"
            >
              {cta.label}
            </Link>
            {secondary && (

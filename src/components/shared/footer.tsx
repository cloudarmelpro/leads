        ...
        <div className="relative z-10">
          <div className="grid grid-cols-1 gap-[clamp(28px,4vw,48px)] md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)_minmax(0,1fr)]">
            ...
            <div data-reveal="left" data-reveal-dist="80px">
              {/* Logo vectoriel (net à toute taille) ; variante `-dark` en mode sombre. */}
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/talgasy-logo.svg" alt={site.name} className="h-11 w-auto dark:hidden" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/talgasy-logo-dark.svg"
                alt={site.name}

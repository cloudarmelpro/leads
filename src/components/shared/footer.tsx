  ...
  return (
    <footer id="footer" className={`relative flex justify-center overflow-hidden border-t border-ligne pt-[clamp(40px,6vw,80px)] ${GOUTTIERE}`}>
      ...
      <div className="relative flex w-full max-w-[1400px] flex-col">
        ...
        <p
          aria-hidden
          className="pointer-events-none m-[0px] mt-[clamp(4px,1vw,12px)] -mb-[0.24em] overflow-hidden text-center text-[clamp(64px,14.5vw,210px)] leading-[0.8] font-medium tracking-[-0.045em] whitespace-nowrap text-encre/[0.1] select-none"
        >
          {site.name}
        </p>
      </div>

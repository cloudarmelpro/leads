...
/**
 * Modale du calendrier (maquette Contact) : voile transparent (la page reste telle quelle, le clic dessus ferme), panneau qui remonte en 300ms
...
export function BookingModal({ dict, calLink, onClose }: Props) {
  ...
  return (
    <div
      onClick={onClose}
      className="fixed inset-[0px] z-[92] flex items-center justify-center p-[clamp(16px,4vw,40px)] motion-safe:[animation:tw-veil-in_220ms_cubic-bezier(0.2,0.7,0.2,1)_both]"
    >
      <div
        ref={panel}
        role="dialog"

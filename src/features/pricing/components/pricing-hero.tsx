  ...
  return (
    <section className={`relative flex justify-center overflow-x-clip pt-[120px] pb-[140px] ${GOUTTIERE}`}>
      ...
      <div className="relative z-[1] flex w-full max-w-[1400px] flex-col items-start gap-[22px]">
        ...
        <Link
          href={`/${lang}/contact`}
          className="mt-[10px] flex h-[38px] items-center rounded-[8px] bg-vert px-[22px] text-[14px] leading-[20px] font-normal text-sur-vert no-underline transition-colors hover:bg-vert-clair"
        >
          {t.cta}
        </Link>
      </div>

...
export function AboutHero({ dict }: Props) {
  ...
  return (
    <section id="top" data-header-sombre className="relative z-[2] block px-[10px] pt-[10px]">
      <div className="relative flex min-h-[min(64svh,640px)] flex-col justify-center overflow-hidden rounded-[24px] bg-[#011B28]">
        ...
        <div className="relative flex justify-center px-[clamp(18px,5vw,72px)] pt-[calc(68px+clamp(28px,5vw,72px))] pb-[calc(76px+clamp(24px,4vh,48px))]">

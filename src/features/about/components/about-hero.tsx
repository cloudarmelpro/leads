  ...
  return (
    <section className={`relative flex justify-center overflow-x-clip pt-[120px] pb-[140px] ${GOUTTIERE}`}>
      ...
      <div className="relative z-[1] flex w-full max-w-[1400px] flex-col items-start gap-[22px]">
        ...
        <a
          href={`/${lang}/contact`}
          className="mt-[10px] flex h-[38px] items-center gap-[10px] rounded-[8px] bg-vert px-[22px] text-[14px] leading-[20px] font-medium text-sur-vert no-underline transition-colors hover:bg-vert-clair"
        >
          {dict.hero.ctaBook}
        </a>
      </div>
